function txt2img_sdelb_hide() {
    const txt2img_sdelb_delete2_info = gradioApp().getElementById('txt2img_sdelb_delete2_info')
    txt2img_sdelb_delete2_info.style.display = 'none'
}

function img2img_sdelb_hide() {
    const img2img_sdelb_delete2_info = gradioApp().getElementById('img2img_sdelb_delete_info2')
    img2img_sdelb_delete2_info.style.display = 'none'
}
...
function txt2img_sdelb_addEventListener() {
    ...
    const txt2img_sdelb_delete2_info = gradioApp().getElementById('txt2img_sdelb_delete2_info')
    txt2img_sdelb_delete2_info.style.display = ''
}
...
function img2img_sdelb_addEventListener() {
    ...
    const img2img_sdelb_delete2_info = gradioApp().getElementById('img2img_sdelb_delete2_info')
    img2img_sdelb_delete2_info.style.display = ''
}
